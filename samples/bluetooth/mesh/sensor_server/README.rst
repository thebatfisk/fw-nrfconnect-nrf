...
In this sample, the on-chip *TEMP_NRF5* temperature sensor is used.
*Button 1* on the board is used to simulate presence detected.
...
#. Set the publishing parameters:
   ...
   #. Retransmit Count should be 0 to avoid duplicate logging in the :ref:`sensor client's <bt_mesh_sensor_cli_readme>` UART terminal.
