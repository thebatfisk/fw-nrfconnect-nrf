...
static struct bt_mesh_whistle_rgb_msg cur_rgb_msg;
...
static void set_rgb_led(struct bt_mesh_whistle_rgb_msg rgb_msg)
{
...
{
	static uint8_t idx;
	const struct bt_mesh_whistle_rgb_msg colors[2] = {
