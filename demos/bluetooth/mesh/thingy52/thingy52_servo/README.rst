...
Paired up with the :ref:`bluetooth_mesh_thingy52_music_client` we have the following usecase:

* Music equalizer - Use three or more Thingy:52 Servers to act as an RGB LED equalizer that reflects music played into the client device.
...
* :ref:`bt_mesh_thingy52_srv_readme` instance to recieve and relay RGB messages.
...
.. important::
   ...
   with either the :ref:`bluetooth_mesh_thingy52_cli` demo, or the :ref:`bluetooth_mesh_thingy52_music_client` running
...
The three remaining device (Server A, B and C) is set up with the Thingy:52 Server Demo. After completing :ref:`bluetooth_mesh_thingy52_srv_prov`
and :ref:`bluetooth_mesh_thingy52_srv_gen_conf_model`
steps for all three Server devices, we set up the following publication scheme using the :ref:`bluetooth_mesh_thingy52_srv_pub_sub` guide:
